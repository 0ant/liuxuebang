...
import com.origwood.liuxue.AppException;
import com.origwood.liuxue.bean.Result;
import com.origwood.liuxue.bean.URLs;
...
public class ApiClient {
	...
	private static String httpGetString(AppContext appContext, String url)
			throws Exception {
		...
		InputStream inStream = http_get(appContext, url);
	...
	private static InputStream http_get(AppContext appContext, String url)
		...
		if (responseBody.contains("result")
			...
			try {
				// Result res = Json2Bean.getBean(content, beanClass);
	...
	private static String _postString(AppContext appContext, String url,
	...
	private static Result http_post(AppContext appContext, String url,
		...
		return Json2Bean.getBean(_postString(appContext, url, params, files),
				Result.class);
	}
	...
	public static Result Login(AppContext appContext, String username,
			String pwd) throws AppException {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("loginName", username);
		params.put("password", pwd);
		try {
			return Json2Bean.getBean(
					httpGetString(appContext, URLs.LOGIN_HTTP), Result.class);
		} catch (Exception e) {
